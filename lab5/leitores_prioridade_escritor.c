...
/* implementação de leitores/escritores com prioridade para o escritor*/
...
int prioridadeEscritor = 0; // define a prioridade do escritor
...
void InicLeit (int id) {
   ...
   printf("L[%d] quer ler\n", id);
   while( prioridadeEscritor > 0 || escr > 0) {
     printf("L[%d] bloqueou\n", id);
